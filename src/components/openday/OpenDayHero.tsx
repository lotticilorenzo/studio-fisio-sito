...
export const OpenDayHero = () => {
    ...
    const { PHONE_HREF, WHATSAPP_MESSAGE, MAX_SEATS, FORMATTED_DATE, IS_PAST_EVENT } = OPENDAY_CONFIG;
            ...
            <div className="relative z-10 w-full max-w-7xl 2xl:max-w-[1600px] mx-auto flex flex-col justify-end">
                <div className="max-w-4xl">
                    ...
                    <h1 className="hero-title font-sans font-bold text-white text-4xl md:text-6xl lg:text-7xl tracking-tight leading-[1.1] mb-6">
                        Fibromialgia e <span className="font-drama italic text-accent">Benessere</span>
                    </h1>
                    ...
                    <div className="hidden md:flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                        <MagneticButton href={`tel:${PHONE_HREF}`} className="hero-cta bg-white text-primary px-8 py-4 sm:px-10 sm:py-5 font-sans font-bold text-base md:text-lg w-full sm:w-auto h-full hover:bg-white/90">
                        ...
                        <MagneticButton href={openDayWaUrl(WHATSAPP_MESSAGE)} className="hero-cta bg-[#25D366] text-white px-8 py-4 sm:px-10 sm:py-5 font-sans font-bold text-base md:text-lg w-full sm:w-auto h-full hover:bg-[#20bd5a]" target="_blank" rel="noopener noreferrer">
                            <div className="flex items-center justify-center gap-3">
