            ...
            <div className="relative z-10 w-full max-w-7xl 2xl:max-w-[1600px] mx-auto flex flex-col justify-end">
                <div className="max-w-4xl">
                    ...
                    <div className="hidden md:flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                        ...
                        <MagneticButton href={openDayWaUrl(WHATSAPP_MESSAGE)} className="hero-cta bg-[#15803d] text-white px-8 py-4 sm:px-10 sm:py-5 font-sans font-bold text-base md:text-lg w-full sm:w-auto h-full hover:bg-[#11602f]" target="_blank" rel="noopener noreferrer">
                            <div className="flex items-center justify-center gap-3">
