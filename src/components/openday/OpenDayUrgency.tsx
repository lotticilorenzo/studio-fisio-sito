...
export const OpenDayUrgency = () => {
    ...
    useEffect(() => {
        // Target date: March 21, 2026 at 9:00 AM Europe/Rome (CET/CEST)
        const targetDate = new Date('2026-03-21T09:00:00+01:00').getTime();
        ...
        <section ref={comp} className="py-24 md:py-32 px-6 lg:px-12 bg-primary relative overflow-hidden text-center z-10">
            ...
            <div className="max-w-4xl mx-auto relative z-10 urg-content">
                ...
                <h2 className="font-drama text-4xl md:text-5xl lg:text-7xl text-white mb-6">
                    I posti stanno <span className="italic text-accent">finendo</span>
                </h2>

                <p className="font-sans text-xl text-white/80 max-w-2xl mx-auto mb-16 leading-relaxed">
                    Ogni consulenza dura 15 minuti per specialista — per garantire qualità, possiamo accogliere solo 30 persone. I posti stanno finendo rapidamente.
                </p>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    <MagneticButton href="tel:+393406794660" className="urg-cta bg-white text-primary px-8 py-4 sm:px-10 sm:py-5 font-sans font-bold text-base md:text-lg w-full sm:w-auto hover:bg-white/90">
                    ...
                    <MagneticButton href={`https://wa.me/393406794660?text=${whatsappMessage}`} className="urg-cta bg-[#25D366] text-white px-8 py-4 sm:px-10 sm:py-5 font-sans font-bold text-base md:text-lg w-full sm:w-auto hover:bg-[#20bd5a]" target="_blank" rel="noopener noreferrer">
                        <div className="flex items-center justify-center gap-3">
