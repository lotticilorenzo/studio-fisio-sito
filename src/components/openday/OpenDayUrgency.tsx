...
export const OpenDayUrgency = () => {
    ...
    const { PHONE_HREF, WHATSAPP_MESSAGE, MAX_SEATS } = OPENDAY_CONFIG;
        ...
        <section ref={comp} className="py-24 md:py-32 px-6 lg:px-12 bg-primary relative overflow-hidden text-center z-10">
            ...
            <div className="max-w-4xl mx-auto relative z-10 urg-content">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    ...
                    <MagneticButton href={openDayWaUrl(WHATSAPP_MESSAGE)} className="urg-cta bg-[#25D366] text-white px-8 py-4 sm:px-10 sm:py-5 font-sans font-bold text-base md:text-lg w-full sm:w-auto hover:bg-[#20bd5a]" target="_blank" rel="noopener noreferrer">
                        <div className="flex items-center justify-center gap-3">
