...
const WA_MESSAGE = encodeURIComponent('Ciao Studio Fisyo! Vorrei informazioni sui vostri servizi.');
...
export const WhatsAppFAB = () => {
    ...
    useEffect(() => {
        // Show FAB after a short delay so it doesn't flash immediately
            ...
            {isVisible && (
                ...
                >
                    ...
                    <a
                        ...
                        className="relative w-14 h-14 rounded-full flex items-center justify-center shadow-2xl transition-transform active:scale-95"
