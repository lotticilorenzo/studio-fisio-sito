            ...
            <div className="max-w-7xl mx-auto flex flex-col">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 lg:gap-8 mb-24">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <a href="mailto:info@studiofisyo.com" className="inline-flex items-center gap-2 font-sans font-medium text-background/50 hover:text-white transition-colors text-sm">
